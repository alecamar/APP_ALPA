...
Mun_app<-readOGR(dsn="../DATA_USE",layer="SP_3523206_APP", use_iconv=TRUE, encoding="UTF-8")
Mun_uso<-readOGR(dsn="../DATA_USE",layer="SP_3523206_USO", use_iconv=TRUE, encoding="UTF-8")
Mun_all<-readOGR(dsn="../DATA_USE",layer="SP_3523206_APP_USO", use_iconv=TRUE, encoding="UTF-8")
```
