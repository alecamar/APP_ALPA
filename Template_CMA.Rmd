...
plot(Mun_uso, col = "transparent", border="black", xlim=c(750000, 770000))
...
legend("topright", c("Floresta", "Formação n Flor", "Silvicultura", "Edificacoes", "Area Antropizada"),
...
```{r, "Uso de solo do Município", echo=FALSE, fig.align='center', fig.width=12, fig.height=9, fig.cap="Uso e cobertura do solo de CMA"}
?par
par(mfrow=c(1,2) )
