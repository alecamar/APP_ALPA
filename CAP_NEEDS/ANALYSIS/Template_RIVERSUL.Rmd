...
Mun_app<-readOGR(dsn="../DATA_USE",layer="SP_3543501_APP", use_iconv=TRUE, encoding="UTF-8")
Mun_uso<-readOGR(dsn="../DATA_USE",layer="SP_3543501_USO", use_iconv=TRUE, encoding="UTF-8")
Mun_all<-readOGR(dsn="../DATA_USE",layer="SP_3543501_APP_USO", use_iconv=TRUE, encoding="UTF-8")
```
...
Com isso, temos:  
  ...
  * Nascente: O total de APP, dispostas em nascentes, a ser restaurado em `r Nome_Mun` é de `r soma_nasc[2,]soma_nasc[3,]+soma_nasc[5,]` ha, o que corresponde a `r 100*((soma_nasc[2,]+soma_nasc[3,]+soma_nasc[5,])/colSums(soma_nasc))` % do total de APPs presentes apenas em nascentes do município.
  ...
  * Corpos d'água 10 - 50m: O total de APP, dispostas em corpos d'água 10 - 50m, a ser restaurado em `r Nome_Mun` é de `r soma_cda_50[[2,]+soma_cda_50[[3,]+soma_cda_50[[5,]` ha, o que corresponde a `r 100*((soma_cda_50[[2,]+soma_cda_50[[3,]+soma_cda_50[[5,])/colSums(soma_cda_50))` % do total de APPs presentes apenas em corpos d'água 10 - 50m do município.
