---
title: "APPs de Bom Sucesso de Itararé"
author: "NEEDS"
date: "05/2020"
output: 
  html_document:
...
Mun_app<-readOGR(dsn="../DATA_USE",layer="SP_3507159_APP", use_iconv=TRUE, encoding="UTF-8")
Mun_uso<-readOGR(dsn="../DATA_USE",layer="SP_3507159_USO", use_iconv=TRUE, encoding="UTF-8")
Mun_all<-readOGR(dsn="../DATA_USE",layer="SP_3507159_APP_USO", use_iconv=TRUE, encoding="UTF-8")
...
Nome_Mun<-"Bom Sucesso de Itararé"
```
...
```
  ...
  * Nascente: O total de APP, dispostas em nascentes, a ser restaurado em `r Nome_Mun` é de `r soma_nasc[1,]+soma_nasc[4,]` ha, o que corresponde a `r 100*((soma_nasc[1,]+soma_nasc[4,])/colSums(soma_nasc))` % do total de APPs presentes apenas em nascentes do município.
