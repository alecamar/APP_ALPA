...
legend("bottomleft", c("Floresta", "Formação não florestal", "Silvicultura", "Edificacoes", "Area Antropizada", "Massa d'água"), fill=c("dark green","yellow",
...
```{r, "carrega e classifica os raster", echo=FALSE, warning=FALSE, results='hide'}
...
```{r, echo=FALSE, fig.align='center',fig.width=6,fig.height=6, fig.cap="Figura 3. Alterações na vegetação entre os anos de 2007 e 2017"}
plot(r07+r17, legend = FALSE,col=col_uso(4))
legend("bottomleft", c("Sem alterações", "Perdas 2007-2017", "Ganhos2007-2017", "N/A"), fill=c("green", "red", "blue", "white"), cex = 0.85)
```
