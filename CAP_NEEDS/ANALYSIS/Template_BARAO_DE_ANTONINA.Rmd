---
title: "APPs de Barão de Antonina"
author: "NEEDS"
date: "05/2020"
output: 
  html_document:
...
Mun_app<-readOGR(dsn="../DATA_USE",layer="SP_3505005_APP", use_iconv=TRUE, encoding="UTF-8")
Mun_uso<-readOGR(dsn="../DATA_USE",layer="SP_3505005_USO", use_iconv=TRUE, encoding="UTF-8")
Mun_all<-readOGR(dsn="../DATA_USE",layer="SP_3505005_APP_USO", use_iconv=TRUE, encoding="UTF-8")
```

```{r, "Nome do município que está sendo trabalhado", echo=FALSE}
Nome_Mun<-"Barão de Antonina"
```
...
legend("topright", c("Floresta", "Formação não florestal", "Silvicultura", "Edificacoes", "Area Antropizada", "Massa d'água"), fill=c("dark green","yellow",
...
legend("topright", c("Fragmentos Florestais", "APPs"),
...
```
  ...
  * Nascente: O total de APP, dispostas em nascentes, a ser restaurado em `r Nome_Mun` é de `r soma_nasc[2,]+soma_nasc[4,]` ha, o que corresponde a `r 100*((soma_nasc[2,]+soma_nasc[4,])/colSums(soma_nasc))` % do total de APPs presentes apenas em nascentes do município.
  ...
  * Corpos d'água 10 - 50m: O total de APP, dispostas em corpos d'água 10 - 50m, a ser restaurado em `r Nome_Mun` é de `r soma_cda_50[2,]` ha, o que corresponde a `r 100*((soma_cda_50[2,])/colSums(soma_cda_50))` % do total de APPs presentes apenas em corpos d'água 10 - 50m do município.
