...
```{r, fig.align='center', , fig.width=10, fig.height=4, fig.cap=" Figura 1. Situação dos fragmentos (2007) em diferentes tamanhos de janela"}
par(mfrow=c(1,3))
...
```{r, fig.align='center', fig.width=10, fig.height=4, fig.cap=" Figura 2. Situação dos fragmentos (2017) em diferentes tamanhos de janela"}
par(mfrow=c(1,3))
