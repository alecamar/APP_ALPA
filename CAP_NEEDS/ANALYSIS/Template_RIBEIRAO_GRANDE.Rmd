...
Mun_app<-readOGR(dsn="../DATA_USE",layer="SP_3543253_APP", use_iconv=TRUE, encoding="UTF-8")
Mun_uso<-readOGR(dsn="../DATA_USE",layer="SP_3543253_USO", use_iconv=TRUE, encoding="UTF-8")
Mun_all<-readOGR(dsn="../DATA_USE",layer="SP_3543253_APP_USO", use_iconv=TRUE, encoding="UTF-8")
```

```{r, "Nome do município que está sendo trabalhado", echo=FALSE}
Nome_Mun<-"Ribeirão Grande"
```
