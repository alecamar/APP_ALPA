...
Mun_app<-readOGR(dsn="../DATA_USE",layer="SP_3553807_APP", use_iconv=TRUE, encoding="UTF-8")
Mun_uso<-readOGR(dsn="../DATA_USE",layer="SP_3553807_USO", use_iconv=TRUE, encoding="UTF-8")
Mun_all<-readOGR(dsn="../DATA_USE",layer="SP_3553807_APP_USO", use_iconv=TRUE, encoding="UTF-8")
```

```{r, "Nome do município que está sendo trabalhado", echo=FALSE}
Nome_Mun<-"Taquarituba"
```
...
Com isso, temos:  
  ...
  * Corpos d'água 10 - 50m: O total de APP, dispostas em corpos d'água 10 - 50m, a ser restaurado em `r Nome_Mun` é de `r soma_cda_50[2,]+soma_cda_50[4,]` ha, o que corresponde a `r 100*((soma_cda_50[2,]+soma_cda_50[4,])/colSums(soma_cda_50))` % do total de APPs presentes apenas em corpos d'água 10 - 50m do município.
